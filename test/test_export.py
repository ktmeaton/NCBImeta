...
def test_export_assemblyvalues(assembly_table_data):
    ...
    test_filename = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "test_Assembly.txt"
    )
...
def test_export_bioprojectvalues(bioproject_table_data):
    ...
    # Setup the assembly table file
    test_filename = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "test_BioProject.txt"
    )
    test_file = open(test_filename, "r")
    # Retrieve the headers and fields
    test_column_list = test_file.readline().strip("\n").split("\t")
...
def test_export_biosamplevalues(biosample_table_data):
    ...
    # Setup the assembly table file
    test_filename = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "test_BioSample.txt"
    )
    test_file = open(test_filename, "r")
    # Retrieve the headers and fields
    test_column_list = test_file.readline().strip("\n").split("\t")
...
def test_export_nucleotidevalues(nucleotide_table_data):
    ...
    # Setup the assembly table file
    test_filename = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "test_Nucleotide.txt"
    )
    test_file = open(test_filename, "r")
    # Retrieve the headers and fields
    test_column_list = test_file.readline().strip("\n").split("\t")
...
def test_export_pubmedvalues(pubmed_table_data):
    ...
    # Setup the assembly table file
    test_filename = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "test_Pubmed.txt"
    )
    test_file = open(test_filename, "r")
    # Retrieve the headers and fields
    test_column_list = test_file.readline().strip("\n").split("\t")
...
def test_export_sravalues(sra_table_data):
    ...
    # Setup the assembly table file
    test_filename = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "test_SRA.txt"
    )
    test_file = open(test_filename, "r")
    # Retrieve the headers and fields
    test_column_list = test_file.readline().strip("\n").split("\t")
...
#
#     func_param = locals().values()
#
#     for table in func_param:
#         table.pop('id', None)
